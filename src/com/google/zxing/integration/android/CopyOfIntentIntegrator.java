 ...
 * @author gcstang
 */
public class CopyOfIntentIntegrator {

	public static final int REQUEST_CODE = 0x0000c0de; // Only use bottom 16
														// bits
	private static final String TAG = CopyOfIntentIntegrator.class.getSimpleName();
	...
	public CopyOfIntentIntegrator(Activity activity) {
